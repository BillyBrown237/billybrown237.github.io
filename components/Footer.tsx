  ...
  return (
    <footer id={"contact"} className={"w-full pb-10 mb-[100px] md:mb-5"}>
      <div className={"flex flex-col items-center"}>
        ...
        <p className={"text-white-200 md:mt-10 my-5 tet-center"}>
          Reach out to me today and let's discuss how i can help you achieve
          your goals
        </p>
        <a href={"mailto:kano.billybrown@gmail.com"}>
          <MagicButton
      ...
      <div
        className={
          "flex mt-16 md:flex-row flex-col justify-between items-center"
        }
      >
        <p className={"md:text-base text-sm md:font-normal font-light"}>
          Copyright © 2024 Billy
        </p>
